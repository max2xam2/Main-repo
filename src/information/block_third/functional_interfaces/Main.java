...
* создадим еще один абстрактный метод. Можно добавлять неограниченное количество методов с реализацией, что не нарушает
...
//----------------------------------------------------------------------------------------------------
    ...
    */
    ...
    /*Также существуют базовые функциональные интерфейсы добавленные в Java 8. Не поддерживает проверяемые исключения,
...
//----------------------------------------------------------------------------------------------------
    ...
    * создания объекта, а не сам объект.*/
    ...
    //Ссылка на метод объекта, который уже создан и аргумент передается как параметр метода
